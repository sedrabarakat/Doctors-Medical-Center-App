...
import 'package:doctor_app/core/helper/date_helper.dart';
...
import 'package:doctor_app/src/features/posts/data/models/post_model.dart';
    ...
    response.fold((error) => emit(AddCommentErrorState()), (data) {
      comments.insert(
          ...
          Comment(
            ...
            userId: HomeCubit.doctorModel!.userId,
            commentableType: "App\\Models\\Post",
            commentableId: 1,
            text: commentController.text,
            createdAt: DateHelper.dateFormat(date: DateTime.now()),
            updatedAt: DateHelper.dateFormat(date: DateTime.now()),
            author: HomeCubit.doctorModel!.userData,
          ));
