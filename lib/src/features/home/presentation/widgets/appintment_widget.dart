...
{required AppointmentModel model}
  ...
  return Padding(
    ...
    child: Container(
      ...
      height: 210.h,width: 200.w,
      child: Column(
        children: [
          SizedBox(height: 20.h,),
        Image_widget(image: null,width: 80),
          SizedBox(height: 20.h,),
          Text(model.patient.personalInformation.fullName),
          Text(model.date),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
            Text_Data(text: 'Time', data: model.start_min,textstyle: StyleManager.fontRegular14black),
          ],)
      ],),
    ),
  );
