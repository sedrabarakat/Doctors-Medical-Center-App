  ...
  return BlocConsumer<ScheduleCubit,ScheduleStates>(
    listener: (context,states){
      if(states is Success_DeleteSpecificSchedule_State) {
        ToastBar.onSuccess(context, message: "Delete", title: "Deleted Successfully");
          ...
          builder: (BuildContext context)=>Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Details",style: StyleManager.fontRegular20White.copyWith(
                        color: Colors.grey
                    ),),
              ...
              Padding(
                ...
                child: Text("Registerations",style: StyleManager.fontRegular20White.copyWith(
                    color: Colors.grey
                ),),
              ),
              Expanded(child: ListView.separated(
                  itemBuilder: (ctx,index)=>patientCell(context:context,model: cubit.specificScheduleModel!.registerations[index]),
                  separatorBuilder: (ctx,index)=>SizedBox(),
                  itemCount: cubit.specificScheduleModel!.registerations.length))
            ],),
          fallback: (BuildContext context)=>Center(child: Lottie.asset('assets/animation/LoadingPatient.json'))
